...
const SkirtIcon = (props) => {
	const stylePrimary = (props.primaryColor !== null) ? { fill: props.primaryColor } : null;
	
	return <svg version="1.1" id="SkirtIcon" x="0px" y="0px" viewBox="0 0 350.56 350.56">
		<g>
			<path style={stylePrimary} d="M345.6,310.88L266.64,45.36V8c0-4.418-3.582-8-8-8H91.92c-4.418,0-8,3.582-8,8v37.36L4.96,310.88
